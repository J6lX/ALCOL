...
public enum CustomStatusCode
{
    ...
    PICTURE_UPLOAD_FAILURE(HttpStatus.CONFLICT, "004", "사진 저장에 실패하였습니다."),
    LOGIN_FAILURE(HttpStatus.CONFLICT, "005", "이메일 또는 비밀번호가 틀렸습니다. 재 로그인 해주세요."),
    LOGIN_SUCCESS(HttpStatus.OK, "006", "로그인에 성공하였습니다.");
